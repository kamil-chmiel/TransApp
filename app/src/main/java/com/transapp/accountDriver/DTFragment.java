    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        addFaultButton.setOnClickListener((View v) ->
        {
            if(description.getText().toString().matches("|0"))
                ...
                Snackbar.make(getActivity().findViewById(R.id.d_t_linearlayout),"The fault for: " + carsSpinner.getSelectedItem().toString() + " has been added !", Snackbar.LENGTH_LONG).show();
